...
- Each card's `Chains with` list is a synapse. Follow it across lobes and pull
  those books' full text when the task touches them.
- For any non-trivial task, pull one distant book to prime the work, the way
  music helps programming. The collective lift is the point.
